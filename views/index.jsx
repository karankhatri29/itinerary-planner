            ...
            <div className="col-lg-6">
              <div className="hero-content text-white">
                ...
                <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                  <a href="#plan-trip" className="btn btn-primary btn-lg px-4 me-md-2">Plan Your Trip</a>
                  <a href="/destinations" className="btn btn-outline-light btn-lg px-4">Explore Destinations</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-5">
        <div className="container">
                  ...
                  <div className="card-body">
                    ...
                    <div className="mb-2">
                      {destination.categories.slice(0, 3).map((category, index) => (
                        <span className="badge bg-secondary me-1" key={index}>{category}</span>
                      ))}
                    </div>
                  </div>
                  <div className="card-footer bg-white border-top-0">
                    <a href={`/destinations/${destination.id}`} className="btn btn-outline-primary">Explore</a>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="text-center mt-4">
            <a href="/destinations" className="btn btn-primary">View All Destinations</a>
          </div>
        </div>
      </section>
            ...
            {categories.map((category) => (
              <div className="col-md-3 col-6 mb-4" key={category.slug}>
                <div className="card category-card h-100 text-center">
                  ...
                  <div className="card-footer bg-white border-top-0">
                    <a href={`/destinations?category=${category.slug}`} className="btn btn-sm btn-outline-primary">Explore</a>
                  </div>
                </div>
              </div>
            ))}
